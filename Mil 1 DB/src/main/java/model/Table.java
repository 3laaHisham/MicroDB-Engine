...
public class Table implements Serializable {
    ...
    public void updateTuples(Hashtable<String, Object> htblColNameValue) throws DBAppException, IOException {
        for (int i = 0; i < getPagesCount(); i++) {
            Page page = serializationManager.deserializePage(this.tableName, i);

            Vector<Tuple> toUpdate = matchesCriteria(page, htblColNameValue);
